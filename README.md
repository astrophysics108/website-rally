...
- Create a directory that is called the same as your GitHub username *inside the `public` and `src` folders*. Place any static files in your `public` folder and any dynamic files in your `src` folder.
